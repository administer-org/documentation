...
| Easy rank management (in the panel)                      | ✅                | ❌ (can't edit)                             | ❌                  | ❌                                 | ❔ (you have to pay for a plugin lmao)                           | ❌                                 |
| Command bar                                              | ❌ (in progress)  | ✅                                          | ✅                  | ❌                                 | ❌                                                               | ✅                                 |
| Actively maintained                                      | ✅                | ❌                                          | ❌                  | ❌                                 | ✅                                                               | ✅                                 |
| Advanced features (server listing, joining players, etc) | ✅                | ✅ (a few)                                  | ❌                  | ❌                                 | ❌                                                               | ❔ (if you make it)                |
| Fully modular (can add/remove core commands)             | ✅                | ❌ (stops you)                              | ❌                  | ❔ (untested)                      | ❔ (community addons but you also have to pay to access it)      | ✅                                 |
| Themes                                                   | ✅                | ✅ (basic colors)                           | ❌                  | ✅                                 | ❌                                                               | ❌                                 |
| Backdoor                                                 | ❌                | ✅ (costs 1200 robux too)                   | ❌                  | ❌                                 | ✅                                                               | ❌                                 |
| Fully editable source with clean code                    | ✅                | ❌ (it'll stop you)                         | ❌                  | ❌ (source was removed from GH)    | ❔ (source is not on GitHub & exe 6 is going paid)               | ✅                                 |
